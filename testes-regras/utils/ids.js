 ...
 */
export function proximoNumero(registros, prefixo) {
 ...
 */
export function proximoNumeroFormatado(registros, prefixo) {
    return proximoNumero(registros.map((registro) => ({ id: registro.id.replace(`${prefixo}-`, prefixo) })), prefixo);
}
