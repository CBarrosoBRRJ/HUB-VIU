 ...
 */
import { carregar, salvar } from './persistencia.js';
/** Os limites da régua. Fora deles é zoom, e zoom é papel do navegador. */
export const FAIXA_FATOR = { min: 0.9, max: 1.15 };
 ...
 */
export function aplicarFatorTexto(fator) {
...
export function restaurarFatorTexto() {
